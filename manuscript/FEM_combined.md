...
The equal-weight composite is therefore retained as the operational default for the v2.0.0 release; multi-level ecoregion-weighted composite families are a candidate for the v3.0.0 release where the +0.015 R² combined gain is application-meaningful. Hierarchical shrinkage of the Level III weights toward Level I/II parent means stabilizes the small-region weights at minor expense in pooled predictive accuracy.
