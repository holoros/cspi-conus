...
The honest reading is that wind exposure operates predominantly through correlated climate and terrain covariates that the v9 stack already includes. Mean wind speed at the TerraClimate resolution does not function as an independent structural axis for asymptotic biomass at the continental scale. Episodic wind disturbance (hurricane swath density, derecho corridors, tornado return periods) was not tested at the plot level in this work and remains a candidate for future investigation if those return-period grids become available at continental scale at finer than 4 km. The 30 m Asym v9 surface released in v3.0.0 (NEWS_v3.0.0.md) is not corrected for wind exposure because no robust corrective signal was identified beyond what the v3 stack already represents.
